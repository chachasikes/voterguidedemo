...
var Measures = React.createClass({
  ...
  readMore: function(value) {
    if (value !== undefined) {
      ...
      return (React.createElement("span", null, React.createElement("a", {href: value, target: "_blank"}, "Read more", React.createElement("span", {className: "glyphicon glyphicon-link glyphicon-xs"}))));
    }
    else {
      return;
    } 
