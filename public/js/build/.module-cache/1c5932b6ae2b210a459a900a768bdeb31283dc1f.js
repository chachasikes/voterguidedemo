  ...
  eachItem: function(item, i) {
    if (item !== null) {
      return (React.createElement("div", {className: "set-item"}, 
        React.createElement("div", {className: "name"}, React.createElement("a", {href: item.url}, item.name), React.createElement("span", {className: "party", type: "party-type-" + item.party_type}, item.party_type)), 
